...
The maintained [delivery queue](delivery-queue.md) now drives ongoing work on editable widget dashboards, full local voice, Gmail/Calendar, weather, chores/charts and selected YouTube playlists. It records implementation boundaries, next ready slices and external acceptance gates. [iPhone testing](iphone-testing.md) separates automated Safari checks from physical camera/microphone and trust setup.
