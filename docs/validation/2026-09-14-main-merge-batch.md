...
PR59 stays at `ac1aef4`, with its retained old UI helper failure. PR77, PR78, PR80 and PR81 retain the precise open gates in the preceding record. They must not be represented as wholly passing or merged merely because an earlier run succeeded.
