...
The complete combined source must still pass the canonical gate, authenticated browser acceptance and an actual clean service package check. Existing manifest and installer receipt schemas remain unchanged by the Life asset addition.
