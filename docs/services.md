...
Automated tests use synthetic private directories, injected launchctl results, synthetic private files. They check lifecycle idempotency, persistent disable/enable, missing GUI sessions, failed stops, unmanaged files, permissions, and log rotation/redaction. These tests do not grant Accessibility or execute native desktop actions.
